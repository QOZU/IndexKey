...
#[derive(Debug)]
pub struct IndexKeyProcessor {
    verbose: bool,
    processed_count: usize,
}

impl IndexKeyProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting IndexKey processing");
    
    let mut processor = IndexKeyProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = IndexKeyProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = IndexKeyProcessor::new(false);
